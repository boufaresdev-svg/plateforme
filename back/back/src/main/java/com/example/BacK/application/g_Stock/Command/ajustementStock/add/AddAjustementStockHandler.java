...
@Component("AddAjustementStockHandler")
@RequiredArgsConstructor
public class AddAjustementStockHandler implements RequestHandler<AddAjustementStockCommand, AddAjustementStockResponse> {
    ...
    @Override
    public AddAjustementStockResponse handle(AddAjustementStockCommand command) {
        // Fetch Article
        ...
        // Create AjustementStock
        AjustementStock ajustementStock = new AjustementStock();
        ...
        // Save
        String id = ajustementStockRepositoryService.add(ajustementStock);
        ...
        return new AddAjustementStockResponse(id, "Ajustement de stock créé avec succès");
    }
}
